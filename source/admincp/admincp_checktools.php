...
//vot		checkfiles('data/log/', '\.htm', 0);
//vot		checkfiles('data/plugindata/', '\.htm', 0);
//vot		checkfiles('data/download/', '\.htm', 0);
...
//vot		checkfiles('uc_client/data/', '\.htm');
