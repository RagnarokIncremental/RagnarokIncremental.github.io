...
/*vot*/		$newstarttime = dgmdate(TIMESTAMP, 'Y-m-d H:i');
/*vot*/		$newendtime = dgmdate(TIMESTAMP + 86400* 7, 'Y-m-d H:i');
...
/*vot*/		$announce['starttime'] = $announce['starttime'] ? dgmdate($announce['starttime'], 'Y-m-d H:i') : "";
/*vot*/		$announce['endtime'] = $announce['endtime'] ? dgmdate($announce['endtime'], 'Y-m-d H:i') : "";
