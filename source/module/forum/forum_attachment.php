...
// Get mimetype that supports html5 media playback. Safari needs mimetype and range support to play correctly
...
// When readmod = 1 or 4, Range is supported
...
function send_file_by_chunk($fp, $limit = PHP_INT_MAX) {
	static $CHUNK_SIZE = 65536; // read 64KB maximum
	$count = 0;
	while (!feof($fp)) {
